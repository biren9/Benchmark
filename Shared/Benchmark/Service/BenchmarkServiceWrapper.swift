...
final class BenchmarkServiceWrapper: ObservableObject {
    @Published private(set) var progress: Double = 0
    @Published private(set) var isRunning = false
    @Published private(set) var scores: [BenchmarkScore] = []
    ...
    init(benchmarkServiceConfigurations: [BenchmarkServiceConfigurationProtocol]) {
